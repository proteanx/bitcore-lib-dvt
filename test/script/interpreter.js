...
var script_tests = require('../data/devaultd/script_tests');
var tx_valid = require('../data/devaultd/tx_valid');
var tx_invalid = require('../data/devaultd/tx_invalid');

//the script string format used in devaultd data tests
Script.fromDevaultdString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected, extraData) {
    var scriptSig = Script.fromDevaultdString(vector[0]);
    var scriptPubkey = Script.fromDevaultdString(vector[1]);
  ...
  describe('devaultd script evaluation fixtures', function() {
  ...
  describe('devaultd transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //devaultd casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.fromDevaultdString(scriptPubKeyStr);
          });
