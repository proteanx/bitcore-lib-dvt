...
describe('Script', function() {
  ...
  describe('#isPushOnly', function() {
    it('should know these scripts are or aren\'t push only', function() {
      ...
      // like devaultd, we regard OP_RESERVED as being "push only"
  ...
  describe('#buildPublicKeyHashOut', function() {
    it('should create script from livenet address', function() {
      var address = Address.fromString('devault:qrk2ulgf99rm0mjfnr39f2jgjqxjd5kwr5rfyamw2k');
      ...
      s.toAddress().toString().should.equal('devault:qrk2ulgf99rm0mjfnr39f2jgjqxjd5kwr5rfyamw2k');
    });
    it('should create script from testnet address', function() {
      var address = Address.fromString('dvtest:qzukhqt0x796hv07tpdhheaze5twhxdnuslxfpzagp');
      var s = Script.buildPublicKeyHashOut(address);
      should.exist(s);
      s.toString().should.equal('OP_DUP OP_HASH160 20 0xb96b816f378babb1fe585b7be7a2cd16eb99b3e4 OP_EQUALVERIFY OP_CHECKSIG');
      s.isPublicKeyHashOut().should.equal(true);
      s.toAddress().toString().should.equal('dvtest:qzukhqt0x796hv07tpdhheaze5twhxdnuslxfpzagp');
    });
  ...
  describe('getData returns associated data', function() {
    ...
    it('for a P2SH address', function() {
      var address = Address.fromString('devault:pzjt8lxnl977xtexlycnl5fyt0al9gcnauyjtqh68n');
  ...
  describe('toAddress', function() {
    ...
    it('for a P2PKH address', function() {
      var stringAddress = 'devault:qrk2ulgf99rm0mjfnr39f2jgjqxjd5kwr5rfyamw2k';
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    it('for a P2SH address', function() {
      var stringAddress = 'devault:pzjt8lxnl977xtexlycnl5fyt0al9gcnauyjtqh68n';
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    ...
    it('works for p2pkh output', function() {
      ...
      script.toAddress().toString().should.equal('devault:qrywzxcwkrf265mzmz20qjyssdql5cdkuyz47850l7');
    });
    it('works for p2pkh input', function() {
      ...
      s2.toAddress().toString().should.equal('devault:qprjfgyvctp82eddvwrup69dvggw63afzg0rfyyvtn');
    });
    ...
    it('works for p2sh output', function() {
      ...
      script.toAddress().toString().should.equal('devault:pzva9yz34uxzntwtjpqqx36jhwnamce7x5whc9x70h');
    });
    it('works for p2sh input', function() {
      ...
      script.toAddress().toString().should.equal('devault:pz30sxmypnge5lv0eyshlt0w5jzu5axu3sl4r37aun');
    });
  ...
  describe('#getSignatureOperationsCount', function() {
    // comes from devaultd src/test/sigopcount_tests
