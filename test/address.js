...
var validbase58 = require('./data/devaultd/base58_keys_valid.json');
var invalidbase58 = require('./data/devaultd/base58_keys_invalid.json');
...
describe('Address', function() {
  ...
  var str = 'devault:qq7rlg754h903afdtvvy8967zgj5sf5exueg36nyc7';
  ...
  describe('devaultd compliance', function() {
  ...
  describe('Cashaddr', function() {
    ...
    //from https://github.com/Devault-UAHF/spec/blob/master/cashaddr.md#examples-of-address-translation
    //
    //
    var t = [
      ['CTH8H8Zj6DSnXFBKQeDG28ogAS92iS16Bp', 'devault:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a'],
      ['Cazk5ZxnJGY1iYqqTefvo7ZtwLYx3YzjgY', 'devault:qr95sy3j9xwd2ap32xkykttr4cvcu7as4y0qverfuy'],
      ['CGZpaFRaJYHqohPJ8BKYvKmxffV2dcmmN9', 'devault:qqq3728yw0y47sqn6l2na30mcw6zm78dzqre909m2r'],
      ['HHLN6S9BcP1JLSrMhgD5qe57iVEMFMLCBT', 'devault:ppm2qsznhks23z7629mms6s4cwef74vcwvn0h829pq'],
      ['HR3ytsYEpS6XXkWskgfkccqLVPeGdXQ1S8', 'devault:pr95sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e'],
      ['H6d4PZ12phrMcu4LRDKNjq3QDiaMDz3fUd', 'devault:pqq3728yw0y47sqn6l2na30mcw6zm78dzq5ucqzc37'],
    ];
    var i;
    ...
    it('should be able to convert a testnet address to a cashaddr', function() {
      ...
      a.toCashAddress().should.equal('dvtest:qry5cr6h2qe25pzwwfrz8m653fh2tf6nusj9dl0ujc');
    });


    it('should be able to convert a testnet address to a cashaddr without prefix', function() {
      var a = new Address('mysKEM9kN86Nkcqwb4gw7RqtDyc552LQoq');
      a.toCashAddress(false).should.equal('dvtest:qry5cr6h2qe25pzwwfrz8m653fh2tf6nusj9dl0ujc');
    });
  ...
  var PKHLivenet = [
    ...
    'devault:qp3awknl3dz8ezu3rmapff3phnzz95kansf0r3rs4x',
  ...
  // livenet p2sh
  var P2SHLivenet = [
    'devault:pqv60krfqv3k3lglrcnwtee6ftgwgaykpccr8hujjz',
  ...
  // testnet p2sh
  var P2SHTestnet = [
    'dvtest:pzvmx80heyrg69ypkkt90rwmknfmmy96av8f02lrrf',
  ...
  //testnet valid
  var PKHTestnet = [
    'dvtest:qr3pswmv0t332gwaedmuhqcp59gswsu2ysdn664dvs',
    'n45x3R2w2jaSC62BMa9MeJCd3TXxgvDEmm',
    'mursDVxqNQmmwWHACpM9VHwVVSfTddGsEM',
    'dvtest:qz82yclajj49kq3cnqk5khs9h2qx5drfruglvwmnac'
  ];
  ...
  describe('validation', function() {
    ...
    it('isValid returns true on network match on cashaddr', function() {
      Address.isValid('devault:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a', 'mainnet').should.equal(true);
      Address.isValid('dvreg:qrjf2q4j0vx7xwqlnzcuy56vk9j9an0z458k0lrw3m', 'regtest').should.equal(true);
      Address.isValid('dvtest:qrzm24wqva0gnvgcsyc0h8tdpgw462mgmc9lef83vw', 'testnet').should.equal(true);
    });

    it('isValid returns false on network mismatch on cashaddr', function() {
      Address.isValid('devault:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a', 'testnet').should.equal(false);
      Address.isValid('dvreg:qrjf2q4j0vx7xwqlnzcuy56vk9j9an0z458k0lrw3m', 'testnet').should.equal(false);
      Address.isValid('dvtest:qrzm24wqva0gnvgcsyc0h8tdpgw462mgmc9lef83vw', 'mainnet').should.equal(false);
    });
    ...
    it('addresses with whitespace are validated correctly', function() {
      ...
      should.not.exist(error);
      Address.fromString(ws).toString().should.equal('devault:qp3awknl3dz8ezu3rmapff3phnzz95kansf0r3rs4x');
    });
  });
  ...
  describe('encodings', function() {
    ...
    it('should make this address from a compressed pubkey', function() {
      ...
      address.toString().should.equal('devault:qp0jaf7jwcf0zlxguv7kcaj05hsxz2lcquxxcxmxtv');
    });
    ...
    it('should make this address from an uncompressed pubkey', function() {
      ...
      a.toString().should.equal('devault:qqazje5ucx2l672lc8cundsa5q9lwdm3rcknh40sxg');
      var b = new Address(pubkey, 'livenet', 'pubkeyhash');
      b.toString().should.equal('devault:qqazje5ucx2l672lc8cundsa5q9lwdm3rcknh40sxg');
    });
    ...
    describe('from a script', function() {
      ...
      it('should make this address from a p2pkh output script', function() {
        ...
        a.toString().should.equal('devault:qrywzxcwkrf265mzmz20qjyssdql5cdkuyz47850l7');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('devault:qrywzxcwkrf265mzmz20qjyssdql5cdkuyz47850l7');
      });
      ...
      it('should make this address from a p2sh input script', function() {
        ...
        var a = Address.fromScript(s, 'livenet');
        a.toString().should.equal('devault:pznw6jhnz5n3uet7uvrc9r655sm9lfwjpu4ufgvysw');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('devault:pznw6jhnz5n3uet7uvrc9r655sm9lfwjpu4ufgvysw');
      });

      it('returns the same address if the script is a pay to public key hash out', function() {
        var address = 'devault:qqazje5ucx2l672lc8cundsa5q9lwdm3rcknh40sxg';
      ...
      it('returns the same address if the script is a pay to script hash out', function() {
        var address = 'devault:ppkzrtrs0jeheyreg222ekspzpsw7r7qzykvzs4uxh';
  ...
  describe('#inspect', function() {
    it('should output formatted output correctly', function() {
      var address = new Address(str);
      var output = '<Address: devault:qq7rlg754h903afdtvvy8967zgj5sf5exueg36nyc7, type: pubkeyhash, network: livenet>';
  ...
  describe('creating a P2SH address from public keys', function() {
    ...
    it('can create an address from a set of public keys', function() {
      ...
      address.toString().should.equal('devault:pzdumagr7ru8w46s8alws4lzruv2c75vsuulp7g59n');
    ...
    it('works on testnet also', function() {
      ...
      address.toString().should.equal('dvtest:pzdumagr7ru8w46s8alws4lzruv2c75vsucd9e2rz0');
    });
