...
describe('Networks', function() {
  ...
  it('should have dvtest prefix', function() {
    expect(networks.get('testnet').prefix).to.equal('dvtest');
  });

  it('should have dvreg prefix', function() {
    expect(networks.get('regtest').prefix).to.equal('dvreg');
  });

  it('#DEPRECATED should not have dvreg prefix after enableRegtest is called', function() {
    var network = networks.get('testnet');
    networks.enableRegtest();
    expect(network.prefix).to.equal('dvtest');
  });

  it('should have dvtest prefix after disableRegtest is called', function() {
    var network = networks.get('testnet');
