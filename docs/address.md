...
Represents a bitcoin address. Addresses are the most popular way to make bitcoin transactions. See [the official Devault Wiki](https://en.bitcoin.it/wiki/Address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/bitpay/bitcore/tree/master/packages/bitcore-lib-dvt/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/bitpay/bitcore/blob/master/packages/bitcore-lib-dvt/lib/errors/spec.js).
