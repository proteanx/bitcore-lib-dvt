...
Represents a bitcoin payment URI. Devault URI strings became the most popular way to share payment request, sometimes as a bitcoin link and others using a QR code.
