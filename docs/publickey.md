...
Represents a bitcoin public key and is needed to be able to receive bitcoin, as is usually represented as a bitcoin [Address](address.md). See the official [Devault Wiki](https://en.bitcoin.it/wiki/Technical_background_of_version_1_Devault_addresses).
